...
def early_stopping(stats, curr_count_to_patience, global_min_loss):
    ...
    latest_val_loss = stats[-1][1]

    # If the latest validation loss is greater or equal to the global minimum loss
    if latest_val_loss >= global_min_loss:
        curr_count_to_patience += 1
    else:
        curr_count_to_patience = 0
        global_min_loss = latest_val_loss
...
def train_epoch(tr_loader, model, criterion, optimizer):
    """
