...
def freeze_layers(model, num_layers=0):
    ...
    # layers_to_freeze = []
    # if num_layers >= 1:
    #     layers_to_freeze.append("layer1")  # assuming naming convention in model
    # if num_layers >= 2:
    #     layers_to_freeze.append("layer3")
    # if num_layers == 3:
    #     layers_to_freeze.append("layer5")
    ...
    for _ in range(num_layers*2):
        layer_pointer = next(layers)
        layer_pointer[1].requires_grad_(False)
